...
export default function ForecastCard({ completeForecast, completeForecastIndex }) {
    ...
    const date1 = new Date(foundObjTomorrow[indexOfFoundObj1].date)
    ...
    const objIndex2 = Math.max(...foundObjInTwoDays.map(obj => obj.forecasts[0].auroraScore))
    const indexOfFoundObj2 = foundObjInTwoDays.findIndex(obj => obj.forecasts[0].auroraScore === objIndex2)

    const value2 = foundObjInTwoDays[indexOfFoundObj2].forecasts[0].auroraScore;
    const great2 = value2 === 95;
    const good2 = value2 === 60;
    const canTry2 = value2 === 30;
    const wait2 = value2 === 5;
    const date2 = new Date(foundObjInTwoDays[indexOfFoundObj2].date)
